...
const icons = {
	add: <g><path d="M8 12H12M12 12H16M12 12V16M12 12V8M12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9706 21 12 21Z" stroke="var(--text-normal)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></g>,
	arrow: <g><polyline fill="none" id="Right" points="8.5 5 15.5 12 8.5 19" stroke="var(--text-normal)" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></g>,
